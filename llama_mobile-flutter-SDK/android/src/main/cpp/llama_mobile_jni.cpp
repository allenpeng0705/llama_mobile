...
static bool extractInitParams(JNIEnv* env, jobject initParamsObj, llama_mobile_init_params_c_t& params, const char*& modelPath, const char*& chatTemplate, const char*& systemPrompt) {
    ...
    // Debug logging
    printf("[JNI] extractInitParams called\n");
    
    // Get fields for Kotlin InitParams
    ...
    const char* cacheTypeK = (cacheTypeKField != nullptr) ? getStringUTFChars(env, cacheTypeKStr) : nullptr;
    const char* cacheTypeV = (cacheTypeVField != nullptr) ? getStringUTFChars(env, cacheTypeVStr) : nullptr;
    
    // Debug model path
    printf("[JNI] Model path: %s\n", modelPath ? modelPath : "null");
...
static bool extractCompletionParams(JNIEnv* env, jobject completionParamsObj, llama_mobile_completion_params_c_t& params, const char*& prompt, const char*& grammar, std::vector<std::string>& mediaPaths) {
    ...
    // Get fields for Kotlin CompletionParams
    ...
    jfieldID typicalPField = env->GetFieldID(paramsClass, "typicalP", "F");
    jfieldID penaltyLastNField = env->GetFieldID(paramsClass, "penaltyLastN", "I");
    jfieldID penaltyRepeatField = env->GetFieldID(paramsClass, "penaltyRepeat", "F");
    jfieldID penaltyFreqField = env->GetFieldID(paramsClass, "penaltyFreq", "F");
    jfieldID penaltyPresentField = env->GetFieldID(paramsClass, "penaltyPresent", "F");
    jfieldID mirostatField = env->GetFieldID(paramsClass, "mirostat", "I");
    jfieldID mirostatTauField = env->GetFieldID(paramsClass, "mirostatTau", "F");
    ...
    jfloat typicalP = (typicalPField != nullptr) ? env->GetFloatField(completionParamsObj, typicalPField) : 1.0f;
    jint penaltyLastN = (penaltyLastNField != nullptr) ? env->GetIntField(completionParamsObj, penaltyLastNField) : 64;
    jfloat penaltyRepeat = (penaltyRepeatField != nullptr) ? env->GetFloatField(completionParamsObj, penaltyRepeatField) : 1.1f;
    jfloat penaltyFreq = (penaltyFreqField != nullptr) ? env->GetFloatField(completionParamsObj, penaltyFreqField) : 0.0f;
    jfloat penaltyPresent = (penaltyPresentField != nullptr) ? env->GetFloatField(completionParamsObj, penaltyPresentField) : 0.0f;
    jint mirostat = (mirostatField != nullptr) ? env->GetIntField(completionParamsObj, mirostatField) : 0;
    jfloat mirostatTau = (mirostatTauField != nullptr) ? env->GetFloatField(completionParamsObj, mirostatTauField) : 5.0f;
...
JNIEXPORT jlong JNICALL Java_com_llamamobile_LlamaMobile_initContext(JNIEnv* env, jobject obj, jobject initParamsObj) {
    ...
    // Debug logging
    printf("[JNI] Java_com_llamamobile_LlamaMobile_initContext called\n");
    
    if (!extractInitParams(env, initParamsObj, params, modelPath, chatTemplate, systemPrompt)) {
        printf("[JNI] extractInitParams failed\n");
        return 0;
    }
    
    // Debug FFI call
    printf("[JNI] Calling llama_mobile_init_context_c with model_path: %s\n", params.model_path);
    
    llama_mobile_context_handle_t context = llama_mobile_init_context_c(&params);
    
    printf("[JNI] llama_mobile_init_context_c returned: %p\n", context);
...
JNIEXPORT jobject JNICALL Java_com_llamamobile_LlamaMobile_nativeGenerateCompletion(JNIEnv* env, jobject obj, jlong contextHandle, jobject completionParamsObj) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT jintArray JNICALL Java_com_llamamobile_LlamaMobile_tokenize(JNIEnv* env, jobject obj, jlong contextHandle, jstring text) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT jstring JNICALL Java_com_llamamobile_LlamaMobile_detokenize(JNIEnv* env, jobject obj, jlong contextHandle, jintArray tokens) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT jfloatArray JNICALL Java_com_llamamobile_LlamaMobile_generateEmbeddings(JNIEnv* env, jobject obj, jlong contextHandle, jstring text) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT jboolean JNICALL Java_com_llamamobile_LlamaMobile_initMultimodal(JNIEnv* env, jobject obj, jlong contextHandle, jstring mmprojPath, jboolean useGpu) {
    if (contextHandle == 0) {
        return JNI_FALSE;
    }
...
JNIEXPORT jboolean JNICALL Java_com_llamamobile_LlamaMobile_isMultimodalEnabled(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return JNI_FALSE;
    }
...
JNIEXPORT jboolean JNICALL Java_com_llamamobile_LlamaMobile_supportsVision(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return JNI_FALSE;
    }
...
JNIEXPORT jboolean JNICALL Java_com_llamamobile_LlamaMobile_supportsAudio(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return JNI_FALSE;
    }
...
JNIEXPORT jstring JNICALL Java_com_llamamobile_LlamaMobile_formatChatMessages(JNIEnv* env, jobject obj, jlong contextHandle, jstring messagesJson, jstring chatTemplate) {
...
JNIEXPORT void JNICALL Java_com_llamamobile_LlamaMobile_releaseMultimodal(JNIEnv* env, jobject obj, jlong contextHandle) {
    llama_mobile_context_t context = reinterpret_cast<llama_mobile_context_t>(contextHandle);
    llama_mobile_release_multimodal_c(context);
}

// Initializes vocoder for text-to-speech
JNIEXPORT jboolean JNICALL Java_com_llamamobile_LlamaMobile_initVocoder(JNIEnv* env, jobject obj, jlong contextHandle, jstring vocoderModelPath) {
    if (contextHandle == 0) {
        return JNI_FALSE;
    }
    ...
    int result = llama_mobile_init_vocoder_c(context, cVocoderModelPath);
...
JNIEXPORT jboolean JNICALL Java_com_llamamobile_LlamaMobile_isVocoderEnabled(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return JNI_FALSE;
    }
...
JNIEXPORT jstring JNICALL Java_com_llamamobile_LlamaMobile_getFormattedAudioCompletion(JNIEnv* env, jobject obj, jlong contextHandle, jstring speakerJson, jstring textToSpeak) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT jintArray JNICALL Java_com_llamamobile_LlamaMobile_getAudioGuideTokens(JNIEnv* env, jobject obj, jlong contextHandle, jstring textToSpeak) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT jfloatArray JNICALL Java_com_llamamobile_LlamaMobile_decodeAudioTokens(JNIEnv* env, jobject obj, jlong contextHandle, jintArray tokens) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT jobjectArray JNICALL Java_com_llamamobile_LlamaMobile_getLoadedLoraAdapters(JNIEnv* env, jobject obj, jlong contextHandle) {
...
JNIEXPORT jobject JNICALL Java_com_llamamobile_LlamaMobile_generateResponse(JNIEnv* env, jobject obj, jlong contextHandle, jstring userMessage, jint maxTokens) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT void JNICALL Java_com_llamamobile_LlamaMobile_clearConversation(JNIEnv* env, jobject obj, jlong contextHandle) {
    llama_mobile_context_t context = reinterpret_cast<llama_mobile_context_t>(contextHandle);
    llama_mobile_clear_conversation_c(context);
}

// Checks if a conversation is currently active
JNIEXPORT jboolean JNICALL Java_com_llamamobile_LlamaMobile_isConversationActive(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return JNI_FALSE;
    }
...
JNIEXPORT jint JNICALL Java_com_llamamobile_LlamaMobile_getContextWindowSize(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return 0;
    }
...
JNIEXPORT jint JNICALL Java_com_llamamobile_LlamaMobile_getEmbeddingDimension(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return 0;
    }
...
JNIEXPORT jstring JNICALL Java_com_llamamobile_LlamaMobile_getModelDescription(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return nullptr;
    }
...
JNIEXPORT jlong JNICALL Java_com_llamamobile_LlamaMobile_getModelSize(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return 0;
    }
...
JNIEXPORT jlong JNICALL Java_com_llamamobile_LlamaMobile_getModelParametersCount(JNIEnv* env, jobject obj, jlong contextHandle) {
    if (contextHandle == 0) {
        return 0;
    }
...
// Downloads a model
JNIEXPORT jobject JNICALL Java_com_llamamobile_LlamaMobile_downloadModel(JNIEnv* env, jobject obj, jobject downloadParamsObj, jobject progressCallback) {
...
JNIEXPORT jstring JNICALL Java_com_llamamobile_LlamaMobile_downloadHfFile(JNIEnv* env, jobject obj, jstring repoId, jstring fileName, jstring localPath, jobject progressCallback, jstring token) {
    // This would require complex code to handle downloading and progress callbacks
    // For now, return null as not implemented
    return nullptr;
}
...
JNIEXPORT void JNICALL Java_com_llamamobile_LlamaMobile_releaseContext(JNIEnv* env, jobject obj, jlong contextHandle) {
    llama_mobile_context_t context = reinterpret_cast<llama_mobile_context_t>(contextHandle);
