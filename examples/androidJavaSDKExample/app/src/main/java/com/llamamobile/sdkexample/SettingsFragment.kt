    ...
    private fun setupFeatureButtons() {
        ...
        binding.embeddingToggle.setOnCheckedChangeListener {
            ...
            appState?.let {
                ...
                // Show toast to inform user they need to reload the model
                activity?.let { activity ->
                    Toast.makeText(activity, "Please reload the model for embedding changes to take effect", Toast.LENGTH_SHORT).show()
                }
            }
        }
