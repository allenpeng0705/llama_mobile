...
/** Mirror of llama_mobile_media_t kind (PATH/BYTES currently supported subset). */
enum class MediaKind { PATH, URI, BYTES }
...
class LlamaEngine private constructor(private val handle: Long) : AutoCloseable {
    ...
    companion object {
        ...
        private fun versionString(): String = Native.version()
    ...
    suspend fun generateSuspend(request: LlamaGenerationRequest, tokenCallback: TokenCallback? = null): LlamaGenerationResult =
