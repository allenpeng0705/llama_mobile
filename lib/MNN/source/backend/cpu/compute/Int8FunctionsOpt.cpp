...
#if MNN_USE_SSE
#include "backend/cpu/x86_x64/sse/GemmInt8.cpp"
#endif
...
#endif // !MNN_USE_NEON && !MNN_USE_SSE
...
#elif MNN_USE_SSE
    gCoreFunc->Int8GemmKernel = _SSE_MNNGemmInt8AddBiasScale_16x4_Unit;
    gCoreFunc->Int8GemmKernelFast = _SSE_MNNGemmInt8AddBiasScale_16x4_Unit;
#else
    gCoreFunc->Int8GemmKernel = MNNGemmInt8AddBiasScale_16x4_Unit;
    gCoreFunc->Int8GemmKernelFast = MNNGemmInt8AddBiasScale_16x4_Unit_FAST;
#endif
...
#else
    // Use the static implementation if available
#endif
#endif
...
#elif MNN_USE_SSE
    gCoreFunc->ConvDepthwiseLineInt8 = _SSE_MNNLineDepthWiseInt8AddBiasScaleUnit;
#else
    gCoreFunc->ConvDepthwiseLineInt8 = MNNLineDepthWiseInt8AddBiasScaleUnit;
#endif
#if MNN_USE_SSE
    gCoreFunc->MNNFloat2Int8 = _SSE_MNNFloat2Int8;
    gCoreFunc->MNNInt8ScaleToFloat = _SSE_MNNInt8ScaleToFloat;
#else
...
#else
    // Use default implementations for non-NEON builds
    gCoreFunc->MNNAvgPoolInt8 = MNNAvgPoolInt8;
    gCoreFunc->MNNMaxPoolInt8 = MNNMaxPoolInt8;
#endif
...
#if defined(__aarch64__) && MNN_USE_NEON
    if (core->supportSDot) {
        // MatMul
