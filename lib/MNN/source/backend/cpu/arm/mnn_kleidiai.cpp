...
size_t KleidiAI::getLhsPackedSize(AccelType type, size_t m, size_t k) {
    ...
    // Only support SME2 implementations for float types
    #if MNN_SME2
    switch(type) {
    case AccelType::FP16:
    ...
    #else
    MNN_ASSERT(0); // Float types only supported with SME2
    #endif
    return 0;
}
...
size_t KleidiAI::getRhsPackedSize(AccelType type, size_t n, size_t k, size_t bl) {
    ...
    case AccelType::FP16:
        ...
        #else
        MNN_ASSERT(0); // FP16 only supported with SME2
        return 0;
        #endif
    case AccelType::FP32:
        #if MNN_SME2
        ...
        #else
        MNN_ASSERT(0); // FP32 only supported with SME2
        return 0;
        #endif
    default:
        MNN_ASSERT(0);
    ...
    case AccelType::QI4_SYM_CHNLQT_F32:
    {
        ...
        #endif
        {
            if(m == 1) {
                ...
                #if defined(__ARM_FEATURE_SVE2_I8MM) || defined(MNN_I8MM)
                kai_run_matmul_clamp_f32_qai8dxp4x8_qsi4cxp4x8_8x4x32_neon_i8mm(m, n, k,
                                                                                (const void *)lhsPacked, (const void *)rhsPacked, (float *)dst,
                                                                                dstStrideRow, dstStrideCol, scalarMin, scalarMax);
                #else
                MNN_ASSERT(0); // I8mm extension required
                #endif
            }
        }
