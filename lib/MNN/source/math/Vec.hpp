...
struct Vec {
    ...
    static inline void transpose4(VecType& vec0, VecType& vec1, VecType& vec2, VecType& vec3) {
        // Handle 4x4 transpose for Vec<float,4> when no SIMD is available
        // Store original values
        T tmp0[4] = {vec0.value[0], vec0.value[1], vec0.value[2], vec0.value[3]};
        T tmp1[4] = {vec1.value[0], vec1.value[1], vec1.value[2], vec1.value[3]};
        T tmp2[4] = {vec2.value[0], vec2.value[1], vec2.value[2], vec2.value[3]};
        T tmp3[4] = {vec3.value[0], vec3.value[1], vec3.value[2], vec3.value[3]};
        
        // Transpose the 4x4 matrix
        vec0.value[0] = tmp0[0]; vec0.value[1] = tmp1[0]; vec0.value[2] = tmp2[0]; vec0.value[3] = tmp3[0];
        vec1.value[0] = tmp0[1]; vec1.value[1] = tmp1[1]; vec1.value[2] = tmp2[1]; vec1.value[3] = tmp3[1];
        vec2.value[0] = tmp0[2]; vec2.value[1] = tmp1[2]; vec2.value[2] = tmp2[2]; vec2.value[3] = tmp3[2];
        vec3.value[0] = tmp0[3]; vec3.value[1] = tmp1[3]; vec3.value[2] = tmp2[3]; vec3.value[3] = tmp3[3];
    }
};
