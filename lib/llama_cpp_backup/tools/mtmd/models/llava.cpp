...
lm_ggml_cgraph * clip_graph_llava::build() {
    ...
    lm_ggml_tensor * positions = lm_ggml_new_tensor_1d(ctx0, GGML_TYPE_I32, n_pos);
    ...
    if (hparams.has_llava_projector) {
        ...
        lm_ggml_tensor * patches = lm_ggml_new_tensor_1d(ctx0, GGML_TYPE_I32, n_patches);
