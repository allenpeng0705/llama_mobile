...
lm_ggml_tensor * llm_build_lfm2::build_moe_feed_forward(lm_ggml_tensor * cur, int il) const {
...
lm_ggml_tensor * llm_build_lfm2::build_dense_feed_forward(lm_ggml_tensor * cur, int il) const {
...
lm_ggml_tensor * llm_build_lfm2::build_attn_block(lm_ggml_tensor *             cur,
...
lm_ggml_tensor * llm_build_lfm2::build_shortconv_block(lm_ggml_tensor * cur, llm_graph_input_rs * inp_recr, int il) {
    ...
    GGML_ASSERT(lm_ggml_are_same_shape(conv, new_conv));
