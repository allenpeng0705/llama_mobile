...
lm_ggml_tensor * llm_build_granite_hybrid::build_attention_layer(lm_ggml_tensor *             cur,
    ...
    if (use_rope) {
        ...
        Kcur = lm_ggml_rope_ext(ctx0, Kcur, inp_pos, rope_factors, n_rot, rope_type, n_ctx_orig, freq_base, freq_scale,
                             ext_factor, attn_factor, beta_fast, beta_slow);
    }
...
lm_ggml_tensor * llm_build_granite_hybrid::build_layer_ffn(lm_ggml_tensor *       cur,
