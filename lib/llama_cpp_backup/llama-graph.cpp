...
void llm_graph_input_pos_bucket::set_input(const llama_ubatch * ubatch) {
    if (pos_bucket) {
        ...
        GGML_ASSERT(lm_ggml_backend_buffer_is_host(pos_bucket->buffer));
...
void llm_graph_input_out_ids::set_input(const llama_ubatch * ubatch) {
    ...
    GGML_ASSERT(lm_ggml_backend_buffer_is_host(out_ids->buffer));
...
void llm_graph_input_mean::set_input(const llama_ubatch * ubatch) {
    if (cparams.embeddings && cparams.pooling_type == LLAMA_POOLING_TYPE_MEAN) {
        ...
        GGML_ASSERT(mean);
        GGML_ASSERT(lm_ggml_backend_buffer_is_host(mean->buffer));
...
void llm_graph_input_cls::set_input(const llama_ubatch * ubatch) {
    ...
    if (cparams.embeddings && (
        ...
        GGML_ASSERT(cls);
        GGML_ASSERT(lm_ggml_backend_buffer_is_host(cls->buffer));
...
void llm_graph_input_rs::set_input(const llama_ubatch * ubatch) {
    ...
    if (s_copy) {
        GGML_ASSERT(lm_ggml_backend_buffer_is_host(s_copy->buffer));
...
void llm_graph_input_attn_no_cache::set_input(const llama_ubatch * ubatch) {
...

    {
        ...
        GGML_ASSERT(lm_ggml_backend_buffer_is_host(self_kq_mask->buffer));
    ...
    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
        ...
        GGML_ASSERT(lm_ggml_backend_buffer_is_host(self_kq_mask_swa->buffer));
...
void llm_graph_input_attn_cross::set_input(const llama_ubatch * ubatch) {
    ...
    GGML_ASSERT(lm_ggml_backend_buffer_is_host(cross_kq_mask->buffer));
    GGML_ASSERT(!ubatch->equal_seqs()); // TODO: use ubatch->n_seqs instead of failing
...
void llm_graph_input_mem_hybrid::set_input(const llama_ubatch * ubatch) {
    ...
    if (inp_rs->s_copy) {
        GGML_ASSERT(lm_ggml_backend_buffer_is_host(inp_rs->s_copy->buffer));
...
lm_ggml_tensor * llm_graph_context::build_moe_ffn(
    ...
    if (arch == LLM_ARCH_GROVEMOE && n_expert != hparams.n_expert) {
        ...
        lm_ggml_tensor * f_sel = lm_ggml_cast(ctx0, selected_experts, GGML_TYPE_F32);
        selected_experts = lm_ggml_cast(ctx0, lm_ggml_scale(ctx0, f_sel, 1.0f / float(hparams.n_group_experts)), GGML_TYPE_I32);
...
lm_ggml_tensor * llm_graph_context::build_inp_embd(lm_ggml_tensor * tok_embd) const {
    ...
    if (ubatch.token) {
        inp->tokens = lm_ggml_new_tensor_1d(ctx0, GGML_TYPE_I32, ubatch.n_tokens);
        ...
        inp->embd = lm_ggml_new_tensor_2d(ctx0, GGML_TYPE_F32, n_embd, ubatch.n_tokens);
...
lm_ggml_tensor * llm_graph_context::build_inp_pos() const {
    ...
    cur = lm_ggml_new_tensor_1d(ctx0, GGML_TYPE_I32, (int64_t)n_tokens*hparams.n_pos_per_embd());
...
lm_ggml_tensor * llm_graph_context::build_inp_attn_scale() const {
    ...
    cur = lm_ggml_new_tensor_3d(ctx0, GGML_TYPE_F32, 1, 1, n_tokens);
    lm_ggml_set_input(cur);
...
lm_ggml_tensor * llm_graph_context::build_inp_out_ids() const {
    ...
    cur = lm_ggml_new_tensor_1d(ctx0, GGML_TYPE_I32, n_outputs);
    lm_ggml_set_input(cur);
...
lm_ggml_tensor * llm_graph_context::build_inp_mean() const {
    ...
    cur = lm_ggml_new_tensor_2d(ctx0, GGML_TYPE_F32, n_tokens, ubatch.n_seqs_unq);
    lm_ggml_set_input(cur);
...
lm_ggml_tensor * llm_graph_context::build_inp_cls() const {
    ...
    cur = lm_ggml_new_tensor_1d(ctx0, GGML_TYPE_I32, ubatch.n_seqs_unq);
    lm_ggml_set_input(cur);
...
lm_ggml_tensor * llm_graph_context::build_inp_cross_embd() const {
    ...
    cur = lm_ggml_new_tensor_2d(ctx0, GGML_TYPE_F32, n_embd, n_enc);
    lm_ggml_set_input(cur);
...
lm_ggml_tensor * llm_graph_context::build_inp_pos_bucket_enc() const {
    ...
    cur = lm_ggml_new_tensor_2d(ctx0, GGML_TYPE_I32, n_tokens, n_tokens);
    lm_ggml_set_input(cur);
...
lm_ggml_tensor * llm_graph_context::build_inp_pos_bucket_dec() const {
    ...
    cur = lm_ggml_new_tensor_2d(ctx0, GGML_TYPE_I32, n_kv, n_tokens);
    lm_ggml_set_input(cur);
...
lm_ggml_tensor * llm_graph_context::build_attn_mha(
    ...
    if (cparams.flash_attn && kq_b == nullptr) {
        ...
        if (k->type == GGML_TYPE_F32) {
            k = lm_ggml_cast(ctx0, k, GGML_TYPE_F16);
        }

        if (v->type == GGML_TYPE_F32) {
            v = lm_ggml_cast(ctx0, v, GGML_TYPE_F16);
        }
...
llm_graph_input_attn_no_cache * llm_graph_context::build_attn_inp_no_cache() const {
    ...
    inp->self_kq_mask = lm_ggml_new_tensor_4d(ctx0, GGML_TYPE_F32, n_tokens, n_tokens, 1, 1);
    lm_ggml_set_input(inp->self_kq_mask);

    inp->self_kq_mask_cnv = cparams.flash_attn ? lm_ggml_cast(ctx0, inp->self_kq_mask, GGML_TYPE_F16) : inp->self_kq_mask;

    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
        inp->self_kq_mask_swa = lm_ggml_new_tensor_4d(ctx0, GGML_TYPE_F32, n_tokens, n_tokens, 1, 1);
        lm_ggml_set_input(inp->self_kq_mask_swa);

        inp->self_kq_mask_swa_cnv = cparams.flash_attn ? lm_ggml_cast(ctx0, inp->self_kq_mask_swa, GGML_TYPE_F16) : inp->self_kq_mask_swa;
    } else {
...
static std::unique_ptr<llm_graph_input_attn_kv> build_attn_inp_kv_impl(
...

    {
        ...
        inp->self_kq_mask = lm_ggml_new_tensor_4d(ctx0, GGML_TYPE_F32, n_kv, n_tokens/n_stream, 1, n_stream);
        lm_ggml_set_input(inp->self_kq_mask);
...
llm_graph_input_attn_cross * llm_graph_context::build_attn_inp_cross() const {
    ...
    inp->cross_kq_mask = lm_ggml_new_tensor_4d(ctx0, GGML_TYPE_F32, n_enc, n_tokens, 1, 1);
    lm_ggml_set_input(inp->cross_kq_mask);

    inp->cross_kq_mask_cnv = cparams.flash_attn ? lm_ggml_cast(ctx0, inp->cross_kq_mask, GGML_TYPE_F16) : inp->cross_kq_mask;
...
llm_graph_input_attn_kv_iswa * llm_graph_context::build_attn_inp_kv_iswa() const {
...

    {
        ...
        inp->self_kq_mask_swa = lm_ggml_new_tensor_4d(ctx0, GGML_TYPE_F32, n_kv, n_tokens/n_stream, 1, n_stream);
        lm_ggml_set_input(inp->self_kq_mask_swa);
...
static std::unique_ptr<llm_graph_input_rs> build_rs_inp_impl(
    ...
    inp->s_copy = lm_ggml_new_tensor_1d(ctx0, GGML_TYPE_I32, n_rs);
