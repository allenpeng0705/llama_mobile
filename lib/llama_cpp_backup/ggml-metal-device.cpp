...
lm_ggml_metal_pipeline_with_params lm_ggml_metal_library_get_pipeline_cpy(lm_ggml_metal_library_t lib, ggml_type tsrc, ggml_type tdst) {
    char base[256];
    char name[256];
...
lm_ggml_metal_pipeline_with_params lm_ggml_metal_library_get_pipeline_get_rows(lm_ggml_metal_library_t lib, ggml_type tsrc) {
    char base[256];
    char name[256];
...
lm_ggml_metal_pipeline_with_params lm_ggml_metal_library_get_pipeline_set_rows(lm_ggml_metal_library_t lib, ggml_type tidx, ggml_type tdst) {
    char base[256];
    char name[256];
...
lm_ggml_metal_pipeline_with_params lm_ggml_metal_library_get_pipeline_repeat(lm_ggml_metal_library_t lib, ggml_type tsrc) {
    char base[256];
    char name[256];
...
lm_ggml_metal_pipeline_with_params lm_ggml_metal_library_get_pipeline_glu(lm_ggml_metal_library_t lib, const lm_ggml_tensor * op) {
    GGML_ASSERT(lm_ggml_is_contiguous_1(op->src[0]));
...
lm_ggml_metal_pipeline_with_params lm_ggml_metal_library_get_pipeline_cumsum_blk(lm_ggml_metal_library_t lib, const lm_ggml_tensor * op) {
    GGML_ASSERT(op->op == LM_GGML_OP_CUMSUM);
...
lm_ggml_metal_pipeline_with_params lm_ggml_metal_library_get_pipeline_tri(lm_ggml_metal_library_t lib, const lm_ggml_tensor * op) {
    GGML_ASSERT(op->op == LM_GGML_OP_TRI);
    GGML_ASSERT(op->src[0]->nb[0] == ggml_type_size(op->src[0]->type));
...
lm_ggml_metal_pipeline_with_params lm_ggml_metal_library_get_pipeline_mul_mv_ext(lm_ggml_metal_library_t lib, ggml_type tsrc0, ggml_type tsrc1, int nsg, int nxpsg, int r1ptg) {
    char base[256];
    char name[256];
